...
export default class Accordion extends React.Component {
    ...
    render() {
        return (
            <div>
                <h1 className="text-4xl font-bold text-left pb-6">FAQS</h1>
    ...
    render() {
        ...
        return (
            <div className="w-full">
                <button className="flex justify-between w-full p-4 text-gray-700 border-b-2 border-accordion-border" onClick={this.handleToggleVisibility}>
